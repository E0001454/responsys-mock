...
import { useTareaCampanaDetails } from '@/composables/tareas/campana/useTareaCampanaDetails'
...
const { formatTimestamp, horarios, stageDetails } = useTareaCampanaDetails(props)
</script>
