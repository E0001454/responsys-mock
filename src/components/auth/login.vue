...
const login = async () => {
  try {
    authStore.isLoggingIn.value = true
...
<template>
  <AuthOverlay :state="authStore.isLoggingIn.value ? 'logging-in' : null" />
        ...
        <div class="grid lg:grid-cols-[1.05fr_1fr]">
          ...
          <div class="relative rounded-b-3xl bg-white p-7 sm:p-9 lg:rounded-r-3xl lg:rounded-bl-none lg:p-10">
            ...
            <button
              ...
              @click="login"
              :disabled="authStore.isLoggingIn.value"
            ...
            >
              ...
              {{ authStore.isLoggingIn.value ? 'Redirigiendo...' : 'Iniciar sesion con Okta' }}
            </button>
